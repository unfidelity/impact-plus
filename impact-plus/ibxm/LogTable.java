...
public class LogTable {
    ...
    private static final /* synthetic */ int TABLE_SHIFT;
    private static final /* synthetic */ int[] exp_2_table;
    private static final /* synthetic */ int INTERP_MASK;
    private static final /* synthetic */ int[] log_2_table;
    ...
    public static int raise_2(int llllllllllllllllIIIIIIIlllIIllIl) {
        int llllllllllllllllIIIIIIIlllIIllII = LogTable.eval_table(exp_2_table, llllllllllllllllIIIIIIIlllIIllIl & Short.MAX_VALUE) << 15;
        return llllllllllllllllIIIIIIIlllIIllII >> 15 - (llllllllllllllllIIIIIIIlllIIllIl >> 15);
    }

    private static int eval_table(int[] llllllllllllllllIIIIIIIlllIIIIlI, int llllllllllllllllIIIIIIIllIlllIlI) {
        int llllllllllllllllIIIIIIIlllIIIIII = llllllllllllllllIIIIIIIllIlllIlI >> 8;
        int llllllllllllllllIIIIIIIllIllllll = llllllllllllllllIIIIIIIllIlllIlI & 0xFF;
        int llllllllllllllllIIIIIIIllIlllllI = llllllllllllllllIIIIIIIlllIIIIlI[llllllllllllllllIIIIIIIlllIIIIII];
        int llllllllllllllllIIIIIIIllIllllIl = llllllllllllllllIIIIIIIlllIIIIlI[llllllllllllllllIIIIIIIlllIIIIII + 1] - llllllllllllllllIIIIIIIllIlllllI;
        int llllllllllllllllIIIIIIIllIllllII = (llllllllllllllllIIIIIIIllIllllIl * llllllllllllllllIIIIIIIllIllllll >> 8) + llllllllllllllllIIIIIIIllIlllllI;
        return llllllllllllllllIIIIIIIllIllllII >> 0;
    }

    public LogTable() {
        LogTable llllllllllllllllIIIIIIIlllIlIlll;
    }

    public static int log_2(int llllllllllllllllIIIIIIIlllIlIIll) {
        int llllllllllllllllIIIIIIIlllIlIIlI = 15;
        while (llllllllllllllllIIIIIIIlllIlIIll < 32768) {
            llllllllllllllllIIIIIIIlllIlIIll <<= 1;
            --llllllllllllllllIIIIIIIlllIlIIlI;
        }
        while (llllllllllllllllIIIIIIIlllIlIIll >= 65536) {
            llllllllllllllllIIIIIIIlllIlIIll >>= 1;
            ++llllllllllllllllIIIIIIIlllIlIIlI;
        }
        return 32768 * llllllllllllllllIIIIIIIlllIlIIlI + LogTable.eval_table(log_2_table, llllllllllllllllIIIIIIIlllIlIIll - 32768);
    }
}
